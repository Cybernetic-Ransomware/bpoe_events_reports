# DEPRECATED — TO BE REMOVED before merging to main.
# This file is obsolete. All models have been moved to src/api/models/.
# DO NOT add new definitions. DO NOT use in new modules.
